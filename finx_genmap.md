...
`anchor=mass-fill mode (user: "continue do up to 10000"; platform cap ≤10 generations/turn → one wave per turn). Loop for every turn: (1) recover if wiped (fetch + reset --hard FETCH_HEAD, rebuild .venv); (2) run tools-render/next-holes.mjs → take top 10 fills ranked 1-hop + seamOk (SKIP any whose source was generated in the PREVIOUS wave — one wave of settling before chaining); (3) generate 10 with sky-lock+exposure-lock prompt, normalize 2048×1024, affine vs source (>22Δ, down-crush≤0.33 floor / up-gain≤1.35); (4) commit+push EARLY; (5) full audit → overwrite chain-audit.txt; (6) ledger row + this cursor; (7) suites. Wave B (next): n351/352←n3, n353/354←n90, n355/356←n63, n357/358←n91, n359←n37, n364←n64; then wave C from fresh planner output (n176/n177 unlock once n348/n350 settle; ring branch middles n628←n315, n627←n314, n159, n630←n32, n317/n318 side; west past n513: n514+). Watch: n5/n4/n8/n2/n1 recurring worst frames = boundary originals (accept+document); canopy list in rules above. n486/n448 seam-bridge experiment = dead end (iter 21).`

...
`anchor=point_correct_2 (n2, green junction) +x fill IN PROGRESS. Iteration 23 queue: (1) close ring branch middle — n628←n315, n627←n314, then center knot n159 (between 628 and 627; source = cleaner side after those land); (2) n317/n318 unlock — n32's other branch via 630: densify n630-side inward first (n32—630—…—317 is 5+ hops, long edits hallucinate); (3) next direct holes by ring scan (fill EAST arc knots then WEST road past n513: n514/n515); (4) gentle offenders if budget: n7 (3 edges worst; sources n55/n106 all bright → boundary original, likely accept + document), n65↔n94, n2↔n336, n256↔n511, n61↔n340 leftover. RULES: after EVERY batch rerun audit & chain-audit.txt; per-pair affine to SOURCE only, down-crush gains allowed to 0.33 floor, up-gains clamp 1.35 (global harmonization dead end bb880b0; exposure-bridge dead end iter 21); canopy frames (greenfrac>0.15 or edge>0.15 in top band: n9, n35-n46, n56, n130, n41, n6) LEGIT dark, never exposure-judge; BOUNDARY seams (n448↔n226, n486↔n244, n82↔n321, n6↔n201, n9↔n116) = accepted documented class, not regression targets.`
